...
class List1 extends Component {
  ...
  render() {
    ...
    return (
      <>
        {this.props.val.every((value) => this.state.array.includes(value)) ? (
          <div className='outer-box'>
            ...
            <div className='col2'>
              ...
              <div className='row2'>
                <div
                  className='position'
                  onClick={() => this.handleClick(this.props.data.role)}
                >
                ...
                <div className='tags'>
                  ...
                  <button
                    onClick={() => this.handleClick(this.props.data.level)}
                  >
                    {this.props.data.level}
                  </button>
                  {this.props.data.languages.map((lang) => (
                    <button onClick={() => this.handleClick(lang)}>
                      {lang}
                    </button>
                  ))}
                </div>
